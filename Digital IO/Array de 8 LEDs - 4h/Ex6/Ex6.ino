...
unsigned long pausa = 200;             // definir variable de temps en ms
...
void loop()
{
  ...
  if (buttonState2 == 1 && buttonState3 == 0) //polsador2 premut, muntat amb Pull-up
  {
   ...
   else if  (buttonState2 == 0 && buttonState3 == 1) //polsador3 premut, muntat amb Pull-up
     {
    digitalWrite(led0, HIGH);    // posar a 5V el pin 5
    digitalWrite(led1, HIGH);    // posar a 5V el pin 6
    digitalWrite(led2, HIGH);    // posar a 5V el pin 7
