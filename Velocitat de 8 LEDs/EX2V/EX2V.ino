...
const byte led5 = 11;         // donar nom al pin 10 de l’Arduino
const byte led6 = 12;         // donar nom al pin 11 de l’Arduino
const byte led7 = 13;         // donar nom al pin 12 de l’Arduino
const byte pot0 = A0;
unsigned long temps = 300;             // definir variable de temps en ms
